...
import {BiSolidMessageSquareDots, BiTask, BiSolidBulb, BiSolidPieChartAlt2, BiSolidDownArrow} from 'react-icons/bi'
...
function LeftSide(props: Props) {
  ...
  return (
    <Container
      backgroundColor={location.pathname.includes("analysis") ? "#ffffff2a" : "#ffffff"}
    ...
    >
      ...
      <List className={styles.sideTabItemContainer}>
        <ListItem disablePadding>
          <div style={{cursor: "pointer", display: "flex", alignItems: "center", marginLeft: "16px", width: "120px", height: "50px", color: "#575757"}} onClick={() => navigateMain()}>
            <AiFillHome size={24} color={`${location.pathname.includes("analysis") ? "#ffffff" : "#575757"}`}/>
            <span style={{marginLeft: "10px", color: `${location.pathname.includes("analysis") ? "#ffffff" : "#575757"}`}}>Home</span>
          </div>
        </ListItem>
            ...
            <div className={styles.TabBarProject} style={{padding: "0px"}}>
              <Accordion
                ...
                style={{
                  ...
                  borderRadius: "0px",
                  boxShadow: "none",
                  color: `${location.pathname.includes("analysis") ? "#ffffff" : "#575757"}`,
                  backgroundColor: `${location.pathname.includes("analysis") ? "#ffffff00" : "#ffffff"}`
                }}
              >
                <AccordionSummary
                  style={{
                  ...
                  expandIcon={<BiSolidDownArrow size={12} color={`${location.pathname.includes("analysis") ? "#ffffff" : "#575757"}`}/>}
                ...
                <AccordionDetails sx={{padding: "0px 16px"}}>
                    {["Chat", "Task", "Board", "Analysis"].map(
                      (text, index) => (
                        <ListItemButton sx={{padding: "0px 0px 0px 4px", marginBottom: "4px", width: "140px", height: "32px"}} className={styles.AccordianItem} onClick={() => {navBarClick(index, pjt.id)}}>
                          {AccordianIcon(index)}
