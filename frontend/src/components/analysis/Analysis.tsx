...
import { nowProject_recoil, workStyle_recoil, keywords_recoil, morningCount_recoil, afternoonCount_recoil, nightCount_recoil, issueCount_recoil, allCategoryCount_recoil, taskCount_recoil } from "../../stores/atom";
...
export default function Analysis({ projectId }: AnalysisProps) {
  ...
  const characterImg = process.env.PUBLIC_URL + `/assets/analysisBg/${workStyle}/${workStyle}2.png`;
    ...
    >
      <div className={styles.analysisHeader}>
        <img
          ...
          src={
            process.env.PUBLIC_URL + `/assets/analysisBg/${workStyle}/${workStyle}3.png`
          }
          alt=""
        />
      ...
      <div className={styles.analysisBody}>
        ...
        <div className={styles.analysisResult}>
          <div className={styles.analysisBodyTitle}>
            <span className={styles.analysisBodyTitleLeft}>TEAM {projectInfo?.teamName}의</span>
      ...
      <div className={styles.analysisFooter}>
        ...
        <div className={styles.analysisInfoContainer}>
          ...
          <span className={styles.analysisItemDesc}>{projectInfo?.startDate} ~ {projectInfo?.endDate}</span>
